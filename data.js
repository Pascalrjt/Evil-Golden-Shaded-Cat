...
const SCENARIOS = {
 ...
 P3:passengerTask("Staged obstruction · Central Station","Search for Central Station’s Ann Street entrance and inspect the information. Before the participant confirms a pickup, tell them: temporary barriers are blocking the kerb. Ask them to do what they would normally do, then choose and confirm a pickup. All controls work as usual; pause the timer only while reading the obstruction script.","ann-street"),
